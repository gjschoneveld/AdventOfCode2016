...
namespace Day7
{
    ...
    {
        public static IEnumerable<string> SubstringsOfLength(this string x, int length)
        {
            var startIndices = Enumerable.Range(0, x.Length - length + 1);
    ...
    class IPv7
    {
        private List<string> regularSequences;
        ...
        public bool SupportsTLS()
        {
            ...
            bool inRegular = regularSequences.Any(rs => rs.ContainsPattern(pattern));
            bool inHypernet = hypernetSequences.Any(hs => hs.ContainsPattern(pattern));

            return inRegular && !inHypernet;
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<IPv7> addresses = input.Select(i => IPv7.Parse(i)).ToList();

            int result1 = addresses.Count(a => a.SupportsTLS());

            Console.WriteLine("Answer 1: {0}", result1);


            int result2 = addresses.Count(a => a.SupportsSSL());
